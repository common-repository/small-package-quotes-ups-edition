...
$site_path = eniture_fs_get_wp_config_path();

function eniture_fs_get_wp_config_path() {
...
$get_option = get_option('ups_small_web_hook_plan_requests');
...
update_option('ups_small_web_hook_plan_requests', wp_json_encode($en_web_hook_requests));
...
if ($plan == "0" || $plan == "1" || $plan == "2" || $plan == "3") {
    ...
    update_option("ups_small_package_expire_days", "$expire_days");
