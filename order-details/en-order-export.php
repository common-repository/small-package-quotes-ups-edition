 ...
 * Order export.
 */
if (!class_exists('Eniture_OrderExport')) {

    class Eniture_OrderExport
    {
        ...
        public function en_async_cron_schedule($schedules)
        {
            $schedules['en_async_cron_every_5_minute'] = array(
                'interval' => 60 * 5,
                'display' => __('Every 5 minute', 'small-package-quotes-ups-edition'),
            );
            return $schedules;
        }
        ...
        public function en_orders_ids()
        {
            try {
                ...
                if ($en_orders_ids_flag != 'executed') {
                    ...
                    $date_from = gmdate('Y-m-d', strtotime('-3 month'));;
        ...
        public function en_orders_sending($orders, $en_orders_ids)
        {
            ...
            $curl_obj = new Eniture_UPS_Small_Curl_Request();
            $response = $curl_obj->ups_small_get_curl_response($url, $post_data);
