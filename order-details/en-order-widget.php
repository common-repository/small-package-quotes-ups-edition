 ...
 * Order widget page.
 */
if (!class_exists('Eniture_OrderWidget')) {

    class Eniture_OrderWidget
    {
        public $en_widget_details = [];
        public $en_free_rate_details = [];
        ...
        function en_order_actions($actions, $order)
        {
                ...
                foreach ($get_formatted_meta_data as $key => $meta_data) {
                    switch ($meta_data->key) {
                        ...
                        case 'en_flat_rate_total':
                            ...
                            break;
                        case 'en_free_rate_details':
                            $this->en_free_rate_details = json_decode($meta_data->value, true);
                            break;
            ...
            add_meta_box('en_additional_order_details', __('Additional Order Details', 'small-package-quotes-ups-edition'), [$this, 'en_order_widget'], get_current_screen()->id, 'side', 'low', 'core');
        ...
        public function en_order_widget()
        {
            ...
            if (!empty($this->en_free_rate_details)) {
                $this->en_show_order_widget($number_shipment, 'Free Rate Shipping', 'Free Rate', [], [], $this->en_free_rate_details, $en_extra_accessories);
            }
        }
