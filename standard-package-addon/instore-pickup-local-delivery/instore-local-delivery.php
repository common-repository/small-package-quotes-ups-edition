...
if (!class_exists("Eniture_UpsSmallWDQuotes")) {

    class Eniture_UpsSmallWDQuotes
    {

        public function __construct()
        {
            add_filter('en_ups_small_wd_update_query_string', array($this, 'en_ups_small_wd_update_query_string'), 10, 1);
            add_filter('en_ups_small_wd_origin_array_set', array($this, 'en_ups_small_wd_origin_array_set'), 10, 1);
            add_filter('en_ups_small_wd_standard_plans', array($this, 'en_ups_small_wd_standard_plans'), 10, 4);
        ...
        public function en_ups_small_wd_standard_plans($post_data, $destination_zip, $origin_array, $package_plugin)
        {
            $action = $this->check_package_plan($package_plugin);
         ...
         * @return string
         */
        public function en_ups_small_wd_update_query_string()
        {
         ...
         * @return array type
         */
        public function en_ups_small_wd_origin_array_set($origin)
        {
