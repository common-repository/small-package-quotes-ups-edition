...
if (typeof en_wd_save_warehouse != 'function')
{
    function en_wd_save_warehouse()
    {
        ...
        var postForm = {
            'action': 'eniture_wd_save_warehouse',
            ...
            'tab': tab,
            // preferred origin
            'pref_loc_lfq': jQuery('#add_warehouses #pref_loc_lfq').val(),
            'pref_loc_spq': jQuery('#add_warehouses #pref_loc_spq').val()
        };
        ...
        jQuery.ajax({
            ...
            success: function (data)
            {
                ...
                if (data.insert_qry == 1) {
                    ...
                    jQuery('tr[id=row_' + WarehpuseDataId + ']').html('<td class="en_wd_warehouse_list_data">' + data.origin_city + '</td><td class="en_wd_warehouse_list_data">' + data.origin_state + '</td><td class="en_wd_warehouse_list_data">' + data.origin_zip + '</td><td class="en_wd_warehouse_list_data">' + data.origin_country + '</td><td class="en_wd_warehouse_list_data"><a href="javascript(0)" title="Edit" onclick="return eniture_wd_edit_warehouse(' + WarehpuseDataId + ')"><img src="' + script.pluginsUrl + '/small-package-quotes-ups-edition/warehouse-dropship/wild/assets/images/edit.png"></a><a href="javascript(0)" title="Delete" onclick="return en_wd_delete_current_warehouse(' + WarehpuseDataId + ');"><img src="' + script.pluginsUrl + '/small-package-quotes-ups-edition/warehouse-dropship/wild/assets/images/delete.png"></a></td>');
...
if (typeof en_wd_delete_current_warehouse != 'function')
{
    function en_wd_delete_current_warehouse(e)
    {
        var tab = get_parameter_by_name('tab');
        var postForm = {
            'action': 'eniture_wd_delete_warehouse',
            'delete_id': e,
            'tab': tab,
        };
 ...
 * @returns {Boolean}
 */
if (typeof eniture_wd_edit_warehouse != 'function')
{
    function eniture_wd_edit_warehouse(e)
    {
        var postForm = {
            'action': 'eniture_wd_edit_warehouse',
            'edit_id': e,
        };
        jQuery.ajax({
            type: 'POST',
            ...
            success: function (data)
            {
                if (data[0]) {
                    ...
                    // preferred origin
                    jQuery('#add_warehouses #pref_loc_lfq').val(data[0].pref_loc_lfq);
                    jQuery('#add_warehouses #pref_loc_spq').val(data[0].pref_loc_spq);
...
if (typeof en_wd_save_dropship != 'function')
{
    function en_wd_save_dropship()
    {
        ...
        var postForm = {
            'action': 'eniture_wd_save_dropship',
            ...
            'tab': tab,
            // preferred origin
            'pref_loc_lfq': jQuery('#add_dropships #pref_loc_lfq').val(),
            'pref_loc_spq': jQuery('#add_dropships #pref_loc_spq').val()
        };
        ...
        jQuery.ajax({
            ...
            success: function (data)
            {
                ...
                if (data.insert_qry == 1) {
                    ...
                    jQuery('tr[id=row_' + WarehpuseDataId + ']').html('<td class="en_wd_dropship_list_data">' + data.nickname + '</td><td class="en_wd_dropship_list_data">' + data.origin_city + '</td><td class="en_wd_dropship_list_data">' + data.origin_state + '</td><td class="en_wd_dropship_list_data">' + data.origin_zip + '</td><td class="en_wd_dropship_list_data">' + data.origin_country + '</td><td class="en_wd_dropship_list_data"><a href="javascript(0)" title="Edit" onclick="return eniture_wd_edit_dropship(' + WarehpuseDataId + ')"><img src="' + script.pluginsUrl + '/small-package-quotes-ups-edition/warehouse-dropship/wild/assets/images/edit.png"></a><a href="javascript(0)" title="Delete" onclick="return en_wd_delete_current_dropship(' + WarehpuseDataId + ');"><img src="' + script.pluginsUrl + '/small-package-quotes-ups-edition/warehouse-dropship/wild/assets/images/delete.png"></a></td>');
 ...
 * @returns {Boolean}
 */
if (typeof eniture_wd_edit_dropship != 'function')
{
    function eniture_wd_edit_dropship(e)
    {
        var postForm = {
            'action': 'eniture_wd_edit_dropship',
            'dropship_edit_id': e,
        };
        jQuery.ajax({
            type: 'POST',
            ...
            success: function (data)
            {
                if (data[0]) {
                    ...
                    // preferred origin
                    jQuery('#add_dropships #pref_loc_lfq').val(data[0].pref_loc_lfq);
                    jQuery('#add_dropships #pref_loc_spq').val(data[0].pref_loc_spq);
...
if (typeof en_wd_confirm_delete_dropship != 'function')
{
    function en_wd_confirm_delete_dropship(e)
    {
        var tab = get_parameter_by_name('tab');
        var postForm = {
            'action': 'eniture_wd_delete_dropship',
