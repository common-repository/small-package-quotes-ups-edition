...
<script type="text/javascript">
    ...
    function change_dropship_zip()
    {
        ...
        jQuery('#en_wd_dropship_city').css('background', 'rgba(255, 255, 255, 1) url("<?php echo esc_url_raw(plugins_url()); ?>/small-package-quotes-ups-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_dropship_state').css('background', 'rgba(255, 255, 255, 1) url("<?php echo esc_url_raw(plugins_url()); ?>/small-package-quotes-ups-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('.city_select_css').css('background', 'rgba(255, 255, 255, 1) url("<?php echo esc_url_raw(plugins_url()); ?>/small-package-quotes-ups-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_dropship_country').css('background', 'rgba(255, 255, 255, 1) url("<?php echo esc_url_raw(plugins_url()); ?>/small-package-quotes-ups-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');

        var postForm = {
            'action': 'eniture_wd_get_address',
            ...
            <div class="content">
                ...
                <form method="post" id="add_dropships">
                    ...
                    if (is_plugin_active('preferred-origin/preferred-origin.php')) {
                        $preferred_provider_lfq = apply_filters('en_pref_origin_lfq', true);
                        $preferred_provider_sqp = apply_filters('en_pref_origin_sqp', true);
                        echo esc_attr($preferred_provider_lfq);
                        echo esc_attr($preferred_provider_sqp);
                    }
                    ?>
                    ...
                    <div class="en_wd_add_warehouse_input">
                        ...
                        <input title="Zip" type="text" maxlength="6" value="" onchange="change_dropship_zip()" name="en_wd_dropship_zip" placeholder="30214" id="en_wd_dropship_zip">
                        <span class="en_wd_err"></span>
                    </div>
                    ...
                    <div class="en_wd_add_warehouse_input">
                        ...
                        <input type="text" class="numericonly" title="Handling Fee / Markup" name="en_wd_dropship_markup" 
                                data-optional="1" value="" placeholder="" id="en_wd_dropship_markup">
                    </div>
                    ...
                    $action_instore = apply_filters("eniture_ups_small_quotes_plans_suscription_and_features" , 'instore_pickup_local_devlivery');
                    if(is_array($action_instore))
                    {
                        $disabled = "disabled_me";
                        $package_required = apply_filters("eniture_ups_small_plans_notification_link" , $action_instore);
                    }
                    ?>
                    ...
                    <div class="heading">
                        ...
                        <div class="pickup-delivery-checkboxes">
                            <h2 class="warehouse_heading pakage_notify"><?php echo $package_required ?></h2>
                        </div>
                        </a>
                    </div>
                    ...
                    <div class="en_wd_add_warehouse_input ">
                        ...
                        <input type="text" title="Offer if address is within (miles):" data-optional="1"  id="instore-pickup-address" class="<?php echo esc_attr($disabled); ?>" name="instore-pickup-address">
                        <span class="en_wd_err"></span>
                    </div>
                    ...
                    <div class="en_wd_add_warehouse_input">
                        <label>Offer if address is within (miles):</label>
                        <input type="text" title="Offer if address is within (miles):" class="<?php echo esc_attr($disabled); ?>" data-optional="1" id="local-delivery-address" name="local-delivery-address">
                    </div>
                    <div class="en_wd_add_warehouse_tagging">
                        <label>Offer if postal code matches:</label>
