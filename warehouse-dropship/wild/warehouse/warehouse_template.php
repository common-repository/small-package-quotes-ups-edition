...
<script type="text/javascript">
    ...
    function change_warehouse_zip()
    {
        ...
        jQuery('#en_wd_origin_city').css('background', 'rgba(255, 255, 255, 1) url("<?php echo esc_url_raw(plugins_url()); ?>/small-package-quotes-ups-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        jQuery('#en_wd_origin_state').css('background', 'rgba(255, 255, 255, 1) url("<?php echo esc_url_raw(plugins_url()); ?>/small-package-quotes-ups-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
        ...
        jQuery('#en_wd_origin_country').css('background', 'rgba(255, 255, 255, 1) url("<?php echo esc_url_raw(plugins_url()); ?>/small-package-quotes-ups-edition/warehouse-dropship/wild/assets/images/processing.gif") no-repeat scroll 50% 50%');
...
<div class="en_wd_setting_section">
    ...
    <?php eniture_warehouse_template(); ?>
            ...
            <div class="content" style="overflow-y: auto; height: 80vh;">
                ...
                <form method="post" id="add_warehouses">
                    ...
                    <div class="en_wd_add_warehouse_input">
                        ...
                        <input type="text" title="Zip"  maxlength="6" onchange="change_warehouse_zip()" value="" name="en_wd_origin_zip" placeholder="30214" id="en_wd_origin_zip">
                        <span class="en_wd_err"></span>
                    </div>
                    ...
                    <div class="en_wd_add_warehouse_input">
                        ...
                        <input type="text" class="numericonly" title="Handling Fee / Markup" name="en_wd_origin_markup"
                            data-optional="1" value="" placeholder="" id="en_wd_origin_markup">
                    </div>
